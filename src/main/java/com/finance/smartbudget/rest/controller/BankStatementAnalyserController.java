...
import com.finance.smartbudget.rest.parsers.BankStatementParser;
import com.finance.smartbudget.rest.service.TransactionsService;
import com.finance.smartbudget.rest.service.StatementAnalyzerService;
    ...
    public void processFileAndSaveTransactions(List<String> lines) {
        ...
        for (Transaction bankTransaction : bankTransactions) {
            transactionsService.addMyTransactionAndUpdateBalance(
                    transactionsMapper.toDto(bankTransaction));
        }
